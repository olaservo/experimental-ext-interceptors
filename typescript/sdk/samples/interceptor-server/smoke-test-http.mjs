// Smoke test over Streamable HTTP. Assumes the sample is already listening, e.g.:
//   node dist/index.js --http=39817 &
//   node smoke-test-http.mjs http://localhost:39817/mcp
//
